...
if (wgUserGroups.indexOf("chatmoderator")!=-1) {
	chatPlugins.modules.multiKick.open = function() {
	  var $multiKickWindowHTML = $.showCustomModal( "MultiKick", '<form method="" name="" class="WikiaForm "><fieldset><div id="multiKickHeader">Select the users you would like to kick:</div><div id="multiKickNames" style="height:250px;overflow-y:scroll;"><table id="multiKickUserTable"></div></fieldset></form>', {
		id: "multiKickWindow",
		width: 400,
		buttons: [
		    {
...
console.log("[OPTIONS] multiKick: Loaded");
